...
import AboutGrid04 from '../assets/about-grid-04.jpg';
import AboutGrid05 from '../assets/about-grid-05.jpg';
import AboutGrid06 from '../assets/about-grid-06.jpg';

/* eslint-disable-next-line */
export interface FeaturesGalleryProps {}

export function FeaturesGallery(props: FeaturesGalleryProps) {
  return (
    <section>
        ...
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            <h2 className="mb-4 h2 font-red-hat-display">
              We help teams by delivering the perfect tools
            </h2>
          ...
          {/* Items */}
          <div className="grid items-start max-w-sm grid-cols-2 gap-4 mx-auto gap-y-8 sm:gap-8 md:grid-cols-4 md:max-w-5xl">
            {/* 1st item */}
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                ...
                ></div>
                <svg
                  className="w-20 h-20 text-teal-500 fill-current"
                  viewBox="0 0 80 80"
              ...
              <div className="font-medium sm:text-lg dark:text-gray-300">
                Founded in 2017
              </div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="relative w-20 h-20 mb-3">
                ...
                ></div>
                <svg
                  className="w-20 h-20 text-indigo-500 fill-current"
                  viewBox="0 0 80 80"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="relative flex flex-col items-center">
              <div className="relative w-20 h-20 mb-3">
                ...
                ></div>
                <svg
                  className="w-20 h-20 text-pink-500 fill-current"
                  viewBox="0 0 80 80"
                  xmlns="http://www.w3.org/2000/svg"
                >
