import './hero-help.module.css';

/* eslint-disable-next-line */
export interface HeroHelpProps {}

export function HeroHelp(props: HeroHelpProps) {
  return (
    <section className="relative">
      {/* Background gradient (light version only) */}
      <div
        className="absolute inset-0 pointer-events-none bg-gradient-to-t from-gray-100 to-white dark:hidden"
        aria-hidden="true"
      ></div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="max-w-2xl mx-auto md:px-4">
              ...
              >
                ...
                >
                  <svg
                    className="flex-shrink-0 w-4 h-4 ml-4 mr-3 "
                    viewBox="0 0 16 16"
