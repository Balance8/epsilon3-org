import './help-list.module.css';

import { useState } from 'react';

import NewsAuthor01 from '../assets/news-author-01.jpg';
import NewsAuthor02 from '../assets/news-author-02.jpg';
...
export function HelpList(props: HelpListProps) {
  ...
  return (
    <section className="relative border-t border-transparent dark:border-gray-800">
      ...
      <div
        className="absolute inset-0 hidden opacity-25 pointer-events-none bg-gradient-to-b from-gray-800 to-gray-900 dark:block"
        aria-hidden="true"
      ></div>
          ...
          <div data-aos="fade-up" data-aos-delay="450">
            ...
            <div className="mb-10">
              <div className="flex flex-wrap justify-center -m-1">
                <button
                  className="inline-flex items-center justify-center px-4 py-2 m-1 font-medium transition duration-150 ease-in-out bg-white rounded-full shadow hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700"
                  onClick={() => setCategory('')}
                >
                  <svg
                  ...
                  <span className="text-gray-600 transition duration-150 ease-in-out dark:text-gray-300">
                    View All
                  </span>
                </button>
                <button
            ...
            <div className="-mb-2">
              ...
              >
                <div className="flex py-5 pr-6 bg-white divide-x divide-gray-200 shadow-2xl dark:bg-gray-800 dark:divide-gray-700">
                  {/* Category icon */}
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="text-teal-100 fill-current dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              >
                <div className="flex py-5 pr-6 bg-white divide-x divide-gray-200 shadow-2xl dark:bg-gray-800 dark:divide-gray-700">
                  ...
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="text-purple-100 fill-current dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              >
                <div className="flex py-5 pr-6 bg-white divide-x divide-gray-200 shadow-2xl dark:bg-gray-800 dark:divide-gray-700">
                  ...
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="text-indigo-100 fill-current dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              >
                <div className="flex py-5 pr-6 bg-white divide-x divide-gray-200 shadow-2xl dark:bg-gray-800 dark:divide-gray-700">
                  ...
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="text-pink-100 fill-current dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
